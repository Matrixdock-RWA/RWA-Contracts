...
const DECIMALS: u8 = 9;
const SYMBOL: vector<u8> = b"MTGM";
const NAME: vector<u8> = b"Matrixdock Silver";
const DESCRIPTION: vector<u8> = b"Matrixdock Silver (MTGM) is ..."; // TODO
...
public struct MTGM has drop {}

// https://move-book.com/programmability/module-initializer.html
fun init(witness: MTGM, ctx: &mut TxContext) {
