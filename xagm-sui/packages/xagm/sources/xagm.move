...
const DECIMALS: u8 = 9;
const SYMBOL: vector<u8> = b"MAGM";
const NAME: vector<u8> = b"Matrixdock Silver";
const DESCRIPTION: vector<u8> = b"Matrixdock Silver (MAGM) is ..."; // TODO
...
public struct MAGM has drop {}

// https://move-book.com/programmability/module-initializer.html
fun init(witness: MAGM, ctx: &mut TxContext) {
