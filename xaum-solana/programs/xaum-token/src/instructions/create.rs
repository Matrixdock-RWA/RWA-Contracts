...
use super::super::mtoken::{state::State, xaum::XAUM_DECIMALS};
    ...
    create_metadata_accounts_v3(
        CpiContext::new(
            ...
            CreateMetadataAccountsV3 {
                ...
                mint: ctx.accounts.mint_account.to_account_info(), // the mint account of the metadata account
